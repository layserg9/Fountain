...
<?php get_header('fountains'); ?>
      ...
      <main class="page">
         <div class="page__main-block main-block">
            <div class="main-block__container _container">
               <div class="main-block__body">
                  <h1 class="main-block__title">Пешеходные фонтаны</h1>
            ...
            <div class="main-block__image _ibg _other">
               <img src="<?php echo get_template_directory_uri(); ?>/img/Examples/1.jpg" alt="Фонтан вашей мечты">
            </div>
         </div>
                        ...
                        <div class="services__item item-service">
                           <div class="item-service__icon">
                              <svg version="1.1" id="Capa_1" fill="currentColor" alt="Пешеходный фонтан"
                                 xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
                                 y="0px" viewBox="0 0 434.85 434.85" xml:space="preserve">
                        ...
                        <div class="services__item item-service">
                           <div class="item-service__icon">
                              <svg version="1.1" id="Capa_1" fill="currentColor" alt="Частный фонтан"
                                 xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
                                 y="0px" viewBox="0 0 511.971 511.971" xml:space="preserve">
		...
		C311.507,17.633,314.673,19.844,318.094,19.844z" />
         ...
         <section class="page_whoweare whoweare _city">
            <div class="whoweare__container _container">
               <div class="whoweare__header header-block">
                  <h2 class="header-block__title _description" data-aos="fade-right">Сухой фонтан, он же пешеходный, он
                     же тротуарный. Ещё их
                     называют
                     плоскостными или безопасными. А наши зарубежные партнёры называют их коротко и сухо
                     "Dry Deck".
                  </h2>
                  <div class="header-block__subtitle _description" data-aos="fade-left">
                     <p>Сухим фонтан называют потому, что у него отсутствует
                        открытая
                        водная поверхность, а водные струи бьют прямо из тротуара и стекают обратно. Пешеходными их
                        называют потому, что можно по этому тротуару ходить. Плоскостными фонтанами их обычно называют
                        архитекторы, с точки зрения планирования и проектирования такой фонтан выглядит как плоская
                        площадка.</p>
                     <p> И совершенно очевидно, что такие фонтаны являются самыми безопасными.</p>
                  </div>
               </div>
         </section>
         <section class="page_whoweare whoweare _city">
            <div class="whoweare__container _container">
               <div class="whoweare__header header-block">
                  <h2 class="header-block__title">Фонтаны, которые мы можем построить
                     для Вас!
                  </h2>
                  <div class="header-block__subtitle">У нас вы можете купить, и заказать строительство пешеходных
                     фонтанов.
                     <hr>
                     Проекты на выбор,
                     стоимость и сроки поставки уточняйте.
                  </div>
               </div>
         </section>
         <section class="page__slider slider _city">
            <div class="slider__container _container">
               <div class="slider__slider">
                  <div class="slider__item slider__item__walk_page">
                     <div class="slider__image slider__image__walk_page"><img src="<?php echo get_template_directory_uri(); ?>/img/walk/1.jpg" alt=""></div>
                     <div class="slider__title">9 струй</div>
                     <div class="slider__price">от 3 000 000 р.</div>
                     <div class="slider__description">Сухой пешеходный динамический фонтан с программным управлением на
                        9 струй. Необходимый размер фонтанной площадки от 6х6 метров.
                     </div>
                  </div>
                  <div class="slider__item slider__item__walk_page">
                     <div class="slider__image slider__image__walk_page"><img src="<?php echo get_template_directory_uri(); ?>/img/walk/2.jpg" alt=""></div>
                     <div class="slider__title">10 струй</div>
                     <div class="slider__price">от 3 300 000 р.</div>
                     <div class="slider__description">Комплект предназначен для создания "сухого" фонтана на 10 струй в
                        конфигурации два ряда по 5 струй или в один ряд с интервалами от 1,0 до 1,5 метров.
                     </div>
                  </div>
                  <div class="slider__item slider__item__walk_page">
                     <div class="slider__image slider__image__walk_page"><img src="<?php echo get_template_directory_uri(); ?>/img/walk/3.jpg" alt=""></div>
                     <div class="slider__title">13 струй</div>
                     <div class="slider__price">от 4 000 000 р.</div>
                     <div class="slider__description">Необходимый размер фонтанной площадки от 7х7 метров. Комплект
                        предназначен для создания "сухого" фонтана на 13 струй с интервалами от 1,0 до 1,5 метров.
                     </div>
                  </div>
                  <div class="slider__item slider__item__walk_page">
                     <div class="slider__image slider__image__walk_page"><img src="<?php echo get_template_directory_uri(); ?>/img/walk/4.jpg" alt=""></div>
                     <div class="slider__title">16 струй</div>
                     <div class="slider__price">от 4 600 000 р.</div>
                     <div class="slider__description">Комплект предназначен для создания "сухого" фонтана на 16 струй в
                        конфигурации в 4 ряда с интервалами от 1,0 до 1,5 метров. Размер фонтанной площадки от 6х6 до
                        8х8 метров.
                     </div>
                  </div>
                  <div class="slider__item slider__item__walk_page">
                     <div class="slider__image slider__image__walk_page"><img src="<?php echo get_template_directory_uri(); ?>/img/walk/5.jpg" alt=""></div>
                     <div class="slider__title">21 струя</div>
                     <div class="slider__price">от 4 900 000 р.</div>
                     <div class="slider__description">Сухой пешеходный динамический фонтан с программным управлением на
                        21 струю. Необходимый размер фонтанной площадки от 8х8 метров.
                     </div>
                  </div>
                  <div class="slider__item slider__item__walk_page">
                     <div class="slider__image slider__image__walk_page"><img src="<?php echo get_template_directory_uri(); ?>/img/walk/6.jpg" alt=""></div>
                     <div class="slider__title">25 струй</div>
                     <div class="slider__price">от 6 200 000 р.</div>
                     <div class="slider__description">Сухой пешеходный фонтан на 25 струй в пять рядов по пять струй с
                        фонтанной площадкой от 7х7 до 10х10 метров.
                     </div>
                  </div>
                  <div class="slider__item slider__item__walk_page">
                     <div class="slider__image slider__image__walk_page"><img src="<?php echo get_template_directory_uri(); ?>/img/walk/7.jpg" alt=""></div>
                     <div class="slider__title">29 струй</div>
                     <div class="slider__price">от 6 900 000 р.</div>
                     <div class="slider__description">Сухой пешеходный динамический фонтан с программным управлением
                        на 29 струй. Необходимый размер фонтанной площадки от 9х9 метров.
                     </div>
                  </div>
                  <div class="slider__item slider__item__walk_page">
                     <div class="slider__image slider__image__walk_page"><img src="<?php echo get_template_directory_uri(); ?>/img/walk/8.png" alt=""></div>
                     <div class="slider__title">33 струи</div>
                     <div class="slider__price">от 7 900 000 р.</div>
                     <div class="slider__description">Сухой пешеходный динамический фонтан с программным управлением.
                        Необходимый размер фонтанной площадки от 12х12 метров.
                     </div>
                  </div>
                  <div class="slider__item slider__item__walk_page">
                     <div class="slider__image slider__image__walk_page"><img src="<?php echo get_template_directory_uri(); ?>/img/walk/9.jpg" alt=""></div>
                     <div class="slider__title">36 струй</div>
                     <div class="slider__price">от 8 250 000 р.</div>
                     <div class="slider__description">Сухой пешеходный динамический фонтан с программным управлением.
                        Необходимый размер фонтанной площадки от 10х10 метров.
                     </div>
                  </div>
                  <div class="slider__item slider__item__walk_page">
                     <div class="slider__image slider__image__walk_page"><img src="<?php echo get_template_directory_uri(); ?>/img/walk/10.jpg" alt=""></div>
                     <div class="slider__title">45 струй</div>
                     <div class="slider__price">от 10 000 000 р.</div>
                     <div class="slider__description">Сухой пешеходный динамический фонтан с программным управлением.
                        Необходимый размер фонтанной площадки от 10х10 метров.
                     </div>
                  </div>
            ...
            <div class="subscribe__container _container">
               <div class="subscribe__body">
                  ...
                  <form action="#" id="form" class="subscribe__form">
                     ...
                     <!-- <input autocomplete="off" type="email" required name="form[]" placeholder="Ваш email"
									class="subscribe__input">
								<button type="submit" class="subscribe__button">Оставить заявку</button> -->
                  </form>
               </div>
            </div>
         </section>
