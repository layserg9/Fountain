...
<main class="page">
	<div class="page__main-block main-block">
		<div class="main-block__container _container">
			<div class="main-block__body">
				<h1 class="main-block__title">Создайте фонтан вашей мечты</h1>
				<div class="main-block__text main-block__br">Ваша идея. <br> Наше решение</div>
				<div class="main-block__buttons">
					<a data-goto=".page__subscribe" href="#" class="main-block__button main-block__button_orange">Оставить
						заявку</a>
				</div>
			</div>
		...
		<div class="main-block__image _ibg">
			<img src="<?php echo get_template_directory_uri(); ?>/img/backer.jpg" alt="Фонтан вашей мечты">
		</div>
	</div>
	<section class="page__services services">
		<div class="services__container _container">
			<div class="services__body">
				<div class="services__column">
					<a href="/city/" class="services__link">
						<div class="services__item item-service">
							<div class="item-service__icon">
								<svg version="1.1" id="Layer_1" fill="currentColor" alt="Городской фонтан"
				...
				v24.909C116.358,137.697,120.118,141.457,124.759,141.457z" />
									<path
										d="M124.759,82.42c4.641,0,8.401-3.76,8.401-8.401c0-31.549,25.666-57.217,57.215-57.217
				...
				S244.577,391.941,255.999,391.941z" />
							...
							<h3 class="item-service__title">Городские фонтаны</h3>
							<div class="item-service__text">Мы строим городские фонтаны</div>
						</div>
					</a>
				</div>
				<div class="services__column">
					<a href="/walk/" class="services__link">
						<div class="services__item item-service">
							<div class="item-service__icon">
								<svg version="1.1" id="Capa_1" fill="currentColor" alt="Пешеходный фонтан"
									xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
									...
									<path
										d="M32.584,153.407c4.142,0,7.5-3.357,7.5-7.5c0-4.193,0.308-8.406,0.915-12.521c0.605-4.098-2.227-7.909-6.324-8.515
									...
									<path
										d="M393.868,133.386c0.608,4.113,0.916,8.326,0.916,12.521c0,4.143,3.357,7.5,7.5,7.5s7.5-3.357,7.5-7.5
							...
							<h3 class="item-service__title">Пешеходные фонтаны</h3>
							<div class="item-service__text"><span>Мы строим пешеходные фонтаны</span></div>
						</div>
					</a>
				</div>
				<div class="services__column">
					<a href="/private/" class="services__link">
						<div class="services__item item-service">
							<div class="item-service__icon">
								<svg version="1.1" id="Capa_1" fill="currentColor" alt="Частный фонтан"
									xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
		...
		C71.986,127.825,75.567,131.406,79.986,131.406z" />
									<path
										d="M439.986,155.406c0-4.418-3.582-8-8-8s-8,3.582-8,8v24c0,4.418,3.582,8,8,8s8-3.582,8-8V155.406z" />
		...
		C439.986,206.988,436.404,203.406,431.986,203.406z" />
									<path
										d="M423.986,99.406v24c0,4.418,3.582,8,8,8s8-3.582,8-8v-24c0-4.418-3.582-8-8-8S423.986,94.988,423.986,99.406z" />
		...
		C311.507,17.633,314.673,19.844,318.094,19.844z" />
							...
							<h3 class="item-service__title">Частные фонтаны</h3>
							<div class="item-service__text">Мы строим частные фонтаны</div>
						</div>
					</a>
				</div>
			</div>
	...
	<section class="page__adventages adventages" data-aos="fade-right">
		<div class="adventages__container _container">
			<div class="adventages__header header-block">
				<h2 class="header-block__title">Нас выбирают</h2>
				<div class="header-block__subtitle">Производим и монтируем фонтаны с 2016 года</div>
			</div>
				...
				<div class="adventages__column">
					<div class="adventages__item">
						<div class="adventages__icon">
							...
							<img src="<?php echo get_template_directory_uri(); ?>/img/icons/Delivery.png"
								alt="Бесплатная доставка">
						</div>
						<div class="adventages__value">0 руб.</div>
						<div class="adventages__text">Бесплатная доставка</div>
					</div>
				</div>
				<div class="adventages__column">
					<div class="adventages__item">
						<div class="adventages__icon">
							<img src="<?php echo get_template_directory_uri(); ?>/img/advent/222.svg" alt="Hours spented">
						</div>
						<div class="adventages__value">100%</div>
						<div class="adventages__text">Работаем только с качественными материалами</div>
					</div>
				</div>
				<div class="adventages__column">
					<div class="adventages__item">
						<div class="adventages__icon">
							<img src="<?php echo get_template_directory_uri(); ?>/img/icons/Support.png" alt="Support">
						</div>
						<div class="adventages__value">24/7</div>
						<div class="adventages__text">Оказываем полную техническую поддержку</div>
					</div>
				</div>
				<div class="adventages__column">
					<div class="adventages__item">
						<div class="adventages__icon">
							<img src="<?php echo get_template_directory_uri(); ?>/img/icons/guarantee.png" alt="guarantee">
						</div>
						<div class="adventages__value">5 лет</div>
						<div class="adventages__text">Гарантия качества</div>
					</div>
				</div>
			</div>
		</div>
	...
	<section class="page__practise practise" data-aos="fade-right">
		<div class="practise__container _container">
			<div class="practise__header header-block">
				<h2 class="header-block__title">Строительство, реконструкция <br> и обслуживание всех видов фонтанов
				</h2>
				<div class="header-block__subtitle">Работаем по всей России</div>
			</div>
			<div class="practise__body">
				<div class="practice__column">
					<article class="practice__item item-practise">
						<div class="item-practise__content">
							<a href="/walk/" class="item-practise__link">
								<h4 class="item-practise__title">Пешеходные</h4>
							</a>

						</div>
						<p class="item-practise__image _ibg">
							<img src="<?php echo get_template_directory_uri(); ?>/img/Examples/1.jpg" alt="Walk fountain">
						</p>
					</article>
				</div>
				<div class="practice__column">
					<article class="practice__item item-practise">
						<div class="item-practise__content">
							<a href="/city/" class="item-practise__link">
								<h4 class="item-practise__title">Коммерческие</h4>
							</a>
						</div>
						<p class="item-practise__image _ibg">
							<img src="<?php echo get_template_directory_uri(); ?>/img/Examples/2.jpg" alt="commerce fountain">
						</p>
					</article>
				</div>
				<div class="practice__column">
					<article class="practice__item item-practise">
						<div class="item-practise__content">
							<a href="/private/" class="item-practise__link">
								<h4 class="item-practise__title">Частные</h4>
							</a>
						</div>
						<p class="item-practise__image _ibg">
							<img src="<?php echo get_template_directory_uri(); ?>/img/Examples/3.jpg" alt="private fountain">
						</p>
					</article>
				</div>
				<div class="practice__column">
					<article class="practice__item item-practise">
						<div class="item-practise__content">
							<a href="/city/" class="item-practise__link">
								<h4 class="item-practise__title">Городские</h4>
							</a>
						</div>
						<p class="item-practise__image _ibg">
							<img src="<?php echo get_template_directory_uri(); ?>/img/Examples/4.jpg" alt="city fountain">
						</p>
					</article>
				</div>
			</div>
	...
	<section class="page_whoweare whoweare">
		<div class="whoweare__container _container">
			<div class="whoweare__header header-block" data-aos="fade-right">
				<h2 class="header-block__title">Выполненные работы и проекты, которые мы можем построить для Вас!
				</h2>

			</div>
			<div class="whoweare__body">
				<div class="whoweare__video" data-aos="fade-right">
					<iframe width="560" height="315" src="https://www.youtube.com/embed/uqGbc54D1xA"
						title="YouTube video player" frameborder="0"
						allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
						allowfullscreen></iframe>
				</div>
				<div class="whoweare__content" data-aos="fade-left">
					<h2 class="whoweare__title">Большой выбор пешеходных фонтанов</h2>
					<div class="whoweare__text"> Любое количество струй на ваш выбор</div>
					<div class="whoweare__items">
						<div class="whoweare__item item-whoweare">
							<div class="item-whoweare__icon">
								<img src="<?php echo get_template_directory_uri(); ?>/img/icons/chip.svg" alt="comunity">
							</div>
							<div class="item-whoweare__body">
								<div class="item-whoweare__title">Программное управление</div>

							</div>
							<div class="whoweare__item item-whoweare">
								<div class="item-whoweare__icon">
									<img src="<?php echo get_template_directory_uri(); ?>/img/icons/LED.svg" alt="Limits">
								</div>
								<div class="item-whoweare__body">
									<div class="item-whoweare__title">Цветная подсветка</div>
	...
	<section class="page__slider slider">
		<div class="slider__container _container">
			<div class="slider__slider slider__home_page">
				<div class="slider__item slider__item__home_page">
					<img src="<?php echo get_template_directory_uri(); ?>/img/Gallery/1.jpg" alt="example_fountain">
				</div>
				<div class="slider__item slider__item__home_page">
					<img src="<?php echo get_template_directory_uri(); ?>/img/Gallery/2.jpg" alt="example_fountain">
				</div>
				<div class="slider__item slider__item__home_page">
					<img src="<?php echo get_template_directory_uri(); ?>/img/Gallery/3.jpg" alt="example_fountain">
				</div>
				<div class="slider__item slider__item__home_page">
					<img src="<?php echo get_template_directory_uri(); ?>/img/Gallery/4.jpg" alt="example_fountain">
				</div>
				<div class="slider__item slider__item__home_page">
					<img src="<?php echo get_template_directory_uri(); ?>/img/Gallery/5.jpeg" alt="example_fountain">
				</div>
				<div class="slider__item slider__item__home_page">
					<img src="<?php echo get_template_directory_uri(); ?>/img/Gallery/6.jpg" alt="example_fountain">
				</div>
				<div class="slider__item slider__item__home_page">
					<img src="<?php echo get_template_directory_uri(); ?>/img/Gallery/7.jpeg" alt="example_fountain">
				</div>
				<div class="slider__item slider__item__home_page">
					<img src="<?php echo get_template_directory_uri(); ?>/img/Gallery/8.jpg" alt="example_fountain">
				</div>
				<div class="slider__item slider__item__home_page">
					<img src="<?php echo get_template_directory_uri(); ?>/img/Gallery/9.jpg" alt="example_fountain">
				</div>
			</div>
		</div>
	</section>
	<section class="page__getintouch getintouch">
		<div class="getintouch__container _container">
			...
			<div class="getintouch__items">
				...
				<div class="getintouch__item item-getintouch">
					<div class="item-getintouch__icon">
						<img src="<?php echo get_template_directory_uri(); ?>/img/icons/Getintouch/telegramm.svg"
							alt="telegramm">
					</div>
					<div class="item-getintouch__emails">
	...
	<section class="page__subscribe subscribe">
		<div class="subscribe__container _container">
			<div class="subscribe__body">
				...
				<form action="#" method="POST" class="subscribe__form" id="form">
					<input id="formName" type="text" name="user_name" class="subscribe__first_name _req" 
						placeholder="Ваше имя">
					<input id="formPhone" type="tel" name="user_phone" class="subscribe__phone_number _req"
						placeholder="+7 (___) ___-____" required>
					<button type="submit" class="subscribe__button">Отправить форму</button>
				</form>
			</div>
		</div>
	</section>
