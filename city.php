         ...
         <div class="page__main-block main-block">
            <div class="main-block__container _container">
               <div class="main-block__body">
                  <h1 class="main-block__title">Фонтаны для городской среды</h1>
            ...
            <div class="main-block__image _ibg _other">
               <img src="<?php echo get_template_directory_uri(); ?>/img/outside-fountain.jpg" alt="Фонтан вашей мечты">
            </div>
         </div>
         ...
         <section class="page__intro intro">
            <div class="intro__container _container">
               <div class="intro__body">
                  <div class="intro__item" data-aos-anchor-placement="top-bottom" data-aos="fade-right">
                     <div class="intro__image"><img src="<?php echo get_template_directory_uri(); ?>/img/чертежи.png" alt="">
                     </div>
                  </div>
                  <div class="intro__item" data-aos="fade-left">
                     <div class="intro__text">
                        <div class="intro__textUp">
                           <h2>Строительство городских фонтанов требует тщательного планирования, творческого подхода и
                              точного исполнения. Важно учитывать различные аспекты, такие как расположение фонтана,
                              размер,
                              дизайн и тип используемых материалов. Ниже приведены некоторые ключевые факторы:</h2>
                        </div>
                        <section class="page__slider slider">
                           <div class="slider__container _container">
                              <div class="slider__slider_text">
                                 <div class="slider__item">
                                    <p><span>Расположение</span>
                                       <hr> Городские фонтаны обычно располагаются в местах с высокой проходимостью,
                                       например, на площадях, в парках или вдоль оживленных улиц. Место должно быть
                                       легко
                                       доступным
                                       и видимым, чтобы прохожие могли любоваться красотой фонтана. Кроме того, в этом
                                       месте должен
                                       быть надежный источник водоснабжения для поддержания потока воды в фонтан.
                                    </p>
                                 </div>
                                 <div class="slider__item">
                                    <p><span>Дизайн</span>
                                       <hr> Дизайн городского фонтана должен быть визуально привлекательным и дополнять
                                       окружающую среду. Хорошо спроектированный фонтан может стать туристической
                                       достопримечательностью и повысить эстетическую привлекательность города. Дизайн
                                       также должен
                                       быть функциональным, чтобы вода текла таким образом, чтобы максимизировать ее
                                       визуальное
                                       воздействие.
                                    </p>
                                 </div>
                                 <div class="slider__item">
                                    <p><span>Габариты</span>
                                       <hr> Размер городского фонтана будет зависеть от различных факторов, таких как
                                       местоположение и доступное пространство, окружающие здания и инфраструктура, а
                                       также
                                       предполагаемое использование фонтана. Большие городские фонтаны могут потребовать
                                       более
                                       сложного проектирования и обслуживания, в то время как небольшие фонтаны могут
                                       быть
                                       проще в
                                       обслуживании.
                                    </p>
                                 ...
                                 <div class="slider__item">
                                    <p><span>Материалы</span>
                                       <hr> Материалы, используемые при строительстве городского фонтана, должны быть
                                       прочными и выдерживать различные погодные условия. Камень, бетон и металлы, такие
                                       как бронза
                                       и нержавеющая сталь, обычно используются при строительстве городских фонтанов.
                                       Кроме
                                       того,
                                       используемые материалы должны быть просты в уходе и содержаться в чистоте.
                                    </p>
                                 </div>
                                 <div class="slider__item">
                                    <p><span>Техническое обслуживание</span>
                                       <hr> Городские фонтаны требуют регулярного технического обслуживания,
                                       чтобы они функционировали и выглядели наилучшим образом. Это включает в себя
                                       регулярную
                                       очистку, ремонт любых повреждений и контроль расхода и качества воды. Ухоженный
                                       городской
                                       фонтан может простоять долгие годы и продолжать служить символом красоты и
                                       культуры.
                                    </p>
                                 </div>
                              </div>
         ...
         <section class="page_whoweare whoweare _city">
            <div class="whoweare__container _container">
               <div class="whoweare__header header-block">
                  ...
                  <div class="header-block__subtitle">У нас вы можете купить, и заказать строительство городских
                     фонтанов.
                     <hr>
                     Проекты на выбор,
         ...
         <section class="page__slider slider _city">
            <div class="slider__container _container">
               <div class="slider__slider" >
                  <div class="slider__item">
                     <div class="slider__image"><img src="<?php echo get_template_directory_uri(); ?>/img/city/1.jpg" alt=""></div>
                     <div class="slider__title">Фонтан шириной 3 метра</div>
                     <div class="slider__price">от 3 000 000 р.</div>
                     <div class="slider__description">Городской фонтан шириной 3 метра из монолитного гидрофобного
                        железобетона. Мощная пенная струя с ночной подсветкой. Насосы в кессоне за пределами фонтана.
                     </div>
                  </div>
                  <div class="slider__item">
                     <div class="slider__image"><img src="<?php echo get_template_directory_uri(); ?>/img/city/2.png" alt=""></div>
                     <div class="slider__title">Фонтан шириной 6 метров</div>
                     <div class="slider__price">от 4 000 000 р.</div>
                     <div class="slider__description">Городской фонтан шириной 6 метров из монолитного гидрофобного
                        железобетона. Мощная пенная струя с ночной подсветкой. Насосы в кессоне за пределами фонтана.
                     </div>
                  </div>
                  <div class="slider__item">
                     <div class="slider__image"><img src="<?php echo get_template_directory_uri(); ?>/img/city/3.jpeg" alt=""></div>
                     <div class="slider__title">Фонтан шириной 9 метров</div>
                     <div class="slider__price">от 5 000 000 р.</div>
                     <div class="slider__description">Городской фонтан шириной 9 метров из монолитного гидрофобного
                        железобетона. Мощная пенная струя с ночной подсветкой. Насосы в кессоне за пределами фонтана.
                     </div>
                  </div>
                  <div class="slider__item">
                     <div class="slider__image"><img src="<?php echo get_template_directory_uri(); ?>/img/city/4.jpg" alt=""></div>
                     <div class="slider__title">Фонтан шириной 12 метров</div>
                     <div class="slider__price">от 6 000 000 р.</div>
                     <div class="slider__description">Городской фонтан шириной 12 метров из монолитного гидрофобного
                        железобетона. Мощная пенная струя с ночной подсветкой. Насосы в кессоне за пределами фонтана.
                     </div>
                  </div>
                  <div class="slider__item">
                     <div class="slider__image"><img src="<?php echo get_template_directory_uri(); ?>/img/city/5.jpg" alt=""></div>
                     <div class="slider__title">Фонтан Дубай мини</div>
                     <div class="slider__price">от 17 000 000 р.</div>
                     <div class="slider__description">Динамический городской фонтан Дубай мини. Для сквера, площади или
                        парка, с ночной подсветкой. Эффектное водное шоу по низкой цене.
                     </div>
                  </div>
               </div>
            </div>
